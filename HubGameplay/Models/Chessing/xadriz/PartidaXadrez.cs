...
namespace xadrez
{
    class PartidaXadrez
    {
        ...
        public int playersssids1 { get;private set; }
        public int playersssids2 { get;private set; }
        ...
        public PartidaXadrez(Playersids player)
        {   
            ...
            playersssids1= player.id1;
            playersssids2= player.id2;
            colocarPecas();
        }
        ...
        {
            Playersids playyys = new Playersids();
